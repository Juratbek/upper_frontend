...
export default class List {
  ...
  render() {
    ...
    if (this._data.items.length) {
      this._data.items.forEach((item, index) => {
        const li = this._make('li', this.CSS.item, { innerHTML: item });
  ...
  get CSS() {
    return {
      ...
      wrapper: classes['cdx-list'],
      wrapperOrdered: classes['cdx-list--ordered'],
      wrapperUnordered: classes['cdx-list--unordered'],
      item: classes['cdx-list__item'],
