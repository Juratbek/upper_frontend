...
const CSS = {
  wrapper: classes['tc-wrap'],
  wrapperReadOnly: classes['tc-wrap--readonly'],
  table: classes['tc-table'],
  row: classes['tc-row'],
  withHeadings: classes['tc-table--heading'],
  rowSelected: classes['tc-row--selected'],
  cell: classes['tc-cell'],
  cellSelected: classes['tc-cell--selected'],
  addRow: classes['tc-add-row'],
  addColumn: classes['tc-add-column'],
};
