...
export default class Popover {
  ...
  static get CSS() {
    return {
      popover: classes['tc-popover'],
      popoverOpened: classes['tc-popover--opened'],
      item: classes['tc-popover__item'],
      itemHidden: classes['tc-popover__item--hidden'],
      itemConfirmState: classes['tc-popover__item--confirm'],
      itemIcon: classes['tc-popover__item-icon'],
      itemLabel: classes['tc-popover__item-label'],
    };
  }
